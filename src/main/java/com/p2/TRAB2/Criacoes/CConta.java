...
public class CConta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Conta Corrente", "Conta Poupança", " " }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(combox1, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3)
                            .addComponent(combox3, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void criarBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_criarBTNActionPerformed
        ...
        if(TipoConta == 0) {
            ContaCorrente contaCorrente = new ContaCorrente(codField.getText(),Double.parseDouble(saldoField.getText()));
            Menu1.contas.add(contaCorrente);
        } else if (TipoConta == 1) {
            ContaPoupanca contaPoupanca = new ContaPoupanca(codField.getText(),Double.parseDouble(saldoField.getText()));
            Menu1.contas.add(contaPoupanca);
        }
    ...
    private void combox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combox3ActionPerformed
         TipoConta = combox3.getSelectedIndex();
